...
class StudentSubjectsScoreAPIView(APIView):
    ...
    def post(request, *args, **kwargs):
        ...
        response_data = {
            "message": f"Student score of {subjects_context[0]['title']} created successfully.",
    ...
    def get(request, *args, **kwargs):
        ...
        for school_data in data_pattern:
            ...
            for class_name, class_info in school_data.items():
                ...
                teacher_info = list(class_info.keys())[0]
                teacher_name = list(teacher_info.keys())[0]
                teacher_students = list(teacher_info.values())[0]

                class_data = {
                    class_name: {
                        teacher_name: teacher_students
                    }
                }

                classes_info.append(class_data)

            school_info["classes"] = classes_info
